...
moduleJs.init({
  ...
  modules: {
    moduleLoginView : {
      name : "moduleMainView" ,    // module name ,Must be the same as you the first parameter you invoke mmoduleJs.createModule
      controller : "js/controllers/mainController.js",
      view : "templates/main.html"
    },
    moduleMainView : {
      name : "moduleDetailView" ,
      controller : "js/controllers/detailController.js",
